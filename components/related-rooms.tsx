...
const relatedRooms = [
  {
    ...
    description: "Elegante camera con arredi tradizionali Pugliese",
  ...
  {
    id: 2,
    name: "camera con 2 bagni e balconcino privato",
    description: "Spaziosa suite ideale per famiglie con balconcino privato",
