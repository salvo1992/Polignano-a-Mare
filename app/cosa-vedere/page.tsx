...
const t_cosa: Record<string, Record<string, string>> = {
  it: {
    ...
    lungomareColombo: "Lungomare Cristoforo Colombo",
    lungomareColumboDesc: "Collega il centro storico allo scoglio dell'eremita, offrendo una vista mozzafiato delle grotte. Durante il percorso potrete fermarvi a visitare il museo di arte contemporanea Pino Pascali.",
    sanVito: "San Vito",
  ...
  en: {
    ...
    lungomareColombo: "Lungomare Cristoforo Colombo",
    lungomareColumboDesc: "It goes from the old town to the scoglio dell'eremita, offering a breathtaking view of the caves. You can also stop to visit the Pino Pascali contemporary art museum.",
    sanVito: "San Vito",
  ...
  fr: {
    ...
    lungomareColombo: "Lungomare Cristoforo Colombo",
    lungomareColumboDesc: "Il relie la vieille ville au rocher de l'ermite, offrant une vue spectaculaire sur les grottes. En chemin, vous pouvez visiter le musee d'art contemporain Pino Pascali.",
    sanVito: "San Vito",
  ...
  es: {
    ...
    lungomareColombo: "Lungomare Cristoforo Colombo",
    lungomareColumboDesc: "Conecta el casco antiguo con el escollo del ermita, ofreciendo una vista impresionante de las cuevas. Durante el recorrido se puede visitar el museo de arte contemporaneo Pino Pascali.",
    sanVito: "San Vito",
  ...
  de: {
    ...
    lungomareColombo: "Lungomare Cristoforo Colombo",
    lungomareColumboDesc: "Er verbindet die Altstadt mit dem Felsen des Eremiten und bietet einen atemberaubenden Blick auf die Grotten. Unterwegs konnen Sie das Museum fur zeitgenossische Kunst Pino Pascali besuchen.",
    sanVito: "San Vito",
...
const polignanoPlaces = [
  { key: "centroStorico", nameKey: "centroStorico", descKey: "centroStoricoDesc", image: "/images/cosa-vedere/centro-storico.jpg" },
  { key: "lamaMonachile", nameKey: "lamaMonachile", descKey: "lamaMonachileDesc", image: "/images/cosa-vedere/lama-monachile.jpg" },
  { key: "lungomareModugno", nameKey: "lungomareModugno", descKey: "lungomareMogungoDesc", image: "/images/cosa-vedere/lungomare-modugno.jpg" },
  { key: "lungomareColombo", nameKey: "lungomareColombo", descKey: "lungomareColumboDesc", image: "/images/cosa-vedere/lungomare-colombo.jpg" },
  { key: "sanVito", nameKey: "sanVito", descKey: "sanVitoDesc", image: "/images/cosa-vedere/san-vito.jpg" },
  { key: "portAlga", nameKey: "portAlga", descKey: "portAlgaDesc", image: "/images/cosa-vedere/portalga.jpg" },
]
